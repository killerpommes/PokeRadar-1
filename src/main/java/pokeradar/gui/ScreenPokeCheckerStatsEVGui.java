...
public class ScreenPokeCheckerStatsEVGui extends ScreenPokeCheckerStatsGui {
    ...
    public void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, "Gender", 95, 115, hexColor);
        this.drawCenteredString(this.mc.fontRendererObj, "Total EV", 174, 115, hexColor);
        ...
        this.drawCenteredString(this.mc.fontRendererObj, this.targetPacket.gender.toString(), 95, 130, hexColor);
        this.drawCenteredString(this.mc.fontRendererObj, evSum + "/510", 174, 130, -1);
        this.drawCenteredString(this.mc.fontRendererObj, "" + ChatFormatting.YELLOW + ChatFormatting.BOLD + String.valueOf((int)(((double)evSum/510)*100)) + "%",174, 144, -1);
