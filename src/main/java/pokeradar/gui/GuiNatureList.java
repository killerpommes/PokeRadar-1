...
public class GuiNatureList extends GuiListExtended
{
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public CategoryEntry(String name)
        {
            ...
            this.labelWidth = GuiNatureList.this.mc.fontRendererObj.getStringWidth(this.labelText);
        }

        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
        {
            GuiNatureList.this.mc.fontRendererObj.drawString(this.labelText, GuiNatureList.this.mc.currentScreen.width / 2 - this.labelWidth / 2, y + slotHeight - GuiNatureList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
        {
            ...
            GuiNatureList.this.mc.fontRendererObj.drawString(this.keyDesc, x + 90 - GuiNatureList.this.maxListLabelWidth, y + slotHeight / 2 - GuiNatureList.this.mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);
            this.btnReset.xPosition = x + 210;
            this.btnReset.yPosition = y;
            this.btnReset.enabled = !this.keybinding.isSetToDefaultValue();
            this.btnReset.drawButton(GuiNatureList.this.mc, mouseX, mouseY);
            ...
            this.btnChangeKeyBinding.drawButton(GuiNatureList.this.mc, mouseX, mouseY);
        }
